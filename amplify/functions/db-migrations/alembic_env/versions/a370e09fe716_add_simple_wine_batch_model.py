...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ORDERED", "AVAILABLE", "SOLD_OUT", name="winebatchstatus"),
            nullable=False,
    ...
    op.create_index(
        op.f("ix_wine_batches_batch_number"),
        "wine_batches",
        ["batch_number"],
        unique=True,
    )
    op.create_index(
        op.f("ix_wine_batches_wine_name"), "wine_batches", ["wine_name"], unique=False
    )

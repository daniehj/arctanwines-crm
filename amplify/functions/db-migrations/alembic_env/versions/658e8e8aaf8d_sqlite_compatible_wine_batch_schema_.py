    ...
    if is_sqlite:
        ...
        try:
            op.add_column(
                "wine_batches",
                sa.Column(
                    "import_date", Date(), nullable=True, comment="Date of import"
                ),
            )
        except Exception:
        ...
        try:
            op.add_column(
                ...
                sa.Column(
                    ...
                    nullable=True,
                    comment="EUR to NOK exchange rate at import",
                ),
            )
        except Exception:
            pass
        ...
        try:
            op.add_column(
                ...
                sa.Column(
                    ...
                    Integer(),
                    nullable=True,
                    comment="Transport cost in NOK øre",
                ),
            )
        except Exception:
            pass
        ...
        try:
            op.add_column(
                ...
                sa.Column(
                    ...
                    Integer(),
                    nullable=True,
                    comment="Customs fee in NOK øre",
                ),
            )
        except Exception:
            pass
        ...
        try:
            op.add_column(
                ...
                sa.Column(
                    ...
                    Integer(),
                    nullable=True,
                    comment="Freight forwarding cost in NOK øre",
                ),
            )
        except Exception:
            pass
        ...
        try:
            op.add_column(
                ...
                sa.Column(
                    ...
                    String(length=20),
                    nullable=True,
                    comment="Fiken synchronization status",
                ),
            )
        except Exception:
            pass
        ...
        try:
            op.add_column(
                "wine_batches",
                sa.Column(
                    "active", Boolean(), nullable=True, comment="Soft delete flag"
                ),
            )
        except Exception:
            pass
        ...
        op.execute(
            "UPDATE wine_batches SET import_date = date('now') WHERE import_date IS NULL"
        )
        ...
        try:
            op.create_table(
                ...
                sa.Column(
                    ...
                    String(length=3),
                    nullable=True,
                    comment="Primary currency (EUR, NOK, USD)",
                ),
                sa.Column(
                    "tax_id",
                    String(length=50),
                    nullable=True,
                    comment="VAT number or tax identification",
                ),
                sa.Column(
                    "id", GUID(), nullable=False, comment="Primary key using UUID"
                ),
                sa.Column(
                    "created_at",
        ...
        try:
            op.create_table(
                "wines",
                sa.Column(
                    "name", String(length=255), nullable=False, comment="Wine name"
                ),
                sa.Column(
                    "producer",
                    String(length=255),
                    nullable=False,
                    comment="Wine producer/winery",
                ),
                sa.Column(
                    "region", String(length=255), nullable=True, comment="Wine region"
                ),
                sa.Column(
                    "country",
                    String(length=100),
                ...
                sa.Column(
                    "vintage", Integer(), nullable=True, comment="Wine vintage year"
                ),
                sa.Column(
                    "grape_varieties",
                    Text(),
                    nullable=True,
                    comment="JSON string of grape varieties",
                ),
                sa.Column(
                    "alcohol_content",
                    DECIMAL(precision=4, scale=2),
                    nullable=True,
                    comment="Alcohol percentage (e.g., 13.5)",
                ),
                sa.Column(
                    "bottle_size_ml",
                    Integer(),
                    nullable=True,
                    comment="Bottle size in milliliters",
                ),
                sa.Column(
                    "product_category",
                    String(length=50),
                    nullable=True,
                    comment="Wine category (red, white, rosé, sparkling, dessert)",
                ),
                sa.Column(
                    "tasting_notes",
                    Text(),
                    nullable=True,
                    comment="Tasting notes and description",
                ),
                sa.Column(
                    "serving_temperature",
                    String(length=50),
                    nullable=True,
                    comment="Recommended serving temperature",
                ),
                sa.Column(
                    "food_pairing",
                    Text(),
                    nullable=True,
                    comment="Food pairing suggestions",
                ),
                sa.Column(
                    "organic", Boolean(), nullable=True, comment="Organic certification"
                ),
                sa.Column(
                    "biodynamic",
                    Boolean(),
                    nullable=True,
                    comment="Biodynamic certification",
                ),
                sa.Column(
                    "fiken_product_id",
                    Integer(),
                    nullable=True,
                    comment="Fiken product ID for sync",
                ),
                sa.Column(
                    "id", GUID(), nullable=False, comment="Primary key using UUID"
                ),
        ...
        op.add_column(
            "wine_batches",
            sa.Column("import_date", Date(), nullable=False, comment="Date of import"),
        )
        op.add_column(
            "wine_batches",
            sa.Column(
                "supplier_id", GUID(), nullable=True, comment="Reference to supplier"
            ),
        )
        op.add_column(
            "wine_batches",
        ...
        op.create_foreign_key(
            None, "wine_batches", "suppliers", ["supplier_id"], ["id"]
        )

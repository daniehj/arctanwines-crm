...
import { Vpc, SecurityGroup, SubnetSelection, Subnet, Port, InterfaceVpcEndpoint, VpcEndpointService, InterfaceVpcEndpointAwsService } from "aws-cdk-lib/aws-ec2";
...
export const apiMainFunction = defineFunction(
  (scope) => {
    ...
    // Create a security group for the Lambda function first
